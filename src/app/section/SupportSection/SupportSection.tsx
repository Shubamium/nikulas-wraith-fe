      ...
      <div className="support-container container">
        <div className="support-part">
          <Window header="Support Me">
            <img
              src="/decor/placeholder_support.png"
              alt=""
        ...
        <div className="media-part">
          <div
            className="media"
            onClick={() => {
              window.open("https://ko-fi.com/nikulaswraith", "_blank");
            }}
          >
            ...
            <div className="details">
              ...
              <p>
                {">>"}{" "}
                <a href="https://ko-fi.com/nikulaswraith" target="_blank">
                  https://ko-fi.com/nikulaswraith
                </a>
              </p>
            </div>
          </div>
          <div
            className="media"
            onClick={() => {
              window.open("https://throne.com/nikulaswraith", "_blank");
            }}
          >
            <img src="/decor/support_text.png" alt="" className="decor_text" />
            <div className="media-logo">
            ...
            <div className="details">
              ...
              <p>
                {">>"}{" "}
                <a href="https://throne.com/nikulaswraith" target="_blank">
                  https://throne.com/nikulaswraith
                </a>
              </p>
            </div>
          </div>
