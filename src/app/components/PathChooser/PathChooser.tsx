    ...
    <div className={`thepaths ${done ? "done" : ""}`}>
      <div className={`path-container ${pathChoosen ? "choosen" : ""}`}>
        <div className="path-picker">
          <div className="title">
            <h2>
              Welcome To The <b>Phantom Realm</b>, Spirit!
            </h2>
          ...
          <div className="paths">
            <div className="path good">
              ...
              >
                ...
                <p>
                  Do you take <br /> the path of good?
                </p>
              </div>
            </div>

            <div
              className="path corruption"
              onClick={() => {
                pathChoosenHandler("bad");
              }}
            >
              <div className="path-button">
                <p>
                  Or the path <br /> of C̸̹̋ȏ̸̧r̶̺̀r̸̛͚u̶̹͗p̴̭͝t̶̨̐į̸͆ó̷̥ǹ̶̥?
                </p>
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  width="136"
      ...
      <div className={`path-result ${pathChoosen ? "choosen" : ""}`}>
        ...
        <div className="bar">
          <div
            className="good-fill"
            style={pathChoosen ? { width: "" + goodPercentage + "%" } : {}}
          ></div>
          <div
            className="cor-fill"
            style={pathChoosen ? { width: "" + badPercentage + "%" } : {}}
          ></div>
        </div>
